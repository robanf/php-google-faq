<?php
    ...
    $array=[
        ...
        [
            ...
            <ol>
                <li>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti: <ol class='test'>^ 
...
<body>
            <div class="d-flex header align-items-center">
                <img src="img/Google-Logo.wine.svg" alt="">
                <a href="#"> Privacy e termini</a>
            </div>

            <div class="my-nav">
                <ul>
                    <li class="ms-0 me-5">Introduzione</li>
                    <li class="ms-0 me-5">Norme sulla privacy</li>
                    <li class="ms-0 me-5">Termini di servizio</li>
                    <li class="ms-0 me-5">Tecnologie</li>
                    <li class="ms-0 me-5">Domande frequenti</li>
                </ul>
                <hr>
            </div>
            ...
            <div class="container-lg my-container">
                <?php for($i=0;$i<5;$i++){ $arrayrisp=explode('^', $array[$i]['risposta']); ?>
                <div class="row justify-content-center my-5">
                    <div class="col-9 ">
                        <h3><?php echo $array[$i]['domanda'] ?></h3>
                        <?php foreach($arrayrisp as $risp){ ?>
                        <p class="my-4"><?php echo $risp ?></p>
                        <?php } ?>
                    </div>
                </div>
                <?php } ?>
